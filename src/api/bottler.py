    ...
    with db.engine.begin() as connection:
        ...
        while current_potions < potion_limit:
            if num_red_ml >= 100 and red_potions < int(potion_limit / 4) and current_potions < potion_limit:
                ...
                num_red_ml -= 100
                current_potions += 1
            if num_green_ml >= 100 and green_potions < int(potion_limit / 4) and current_potions < potion_limit:
                new_green_potions += 1
                num_green_ml -= 100
                current_potions += 1
            if num_blue_ml >= 100 and blue_potions < int(potion_limit / 4) and current_potions < potion_limit:
                new_blue_potions += 1
                num_blue_ml -= 100
                current_potions += 1
            if num_dark_ml >= 100 and dark_potions < int(potion_limit / 4) and current_potions < potion_limit:
                new_dark_potions += 1
                num_dark_ml -= 100
                current_potions += 1
            if num_red_ml >= 50 and num_blue_ml >= 50 and purple_potions < int(potion_limit / 4) and current_potions < potion_limit:
                ...
                num_blue_ml -= 50
                current_potions += 1
            if num_red_ml >= 50 and num_green_ml >= 50 and yellow_potions < int(potion_limit / 4) and current_potions < potion_limit:
                new_yellow_potions += 1
                num_red_ml -= 50
                num_green_ml -= 50
                current_potions += 1
            if num_blue_ml >= 50 and num_green_ml >= 50 and teal_potions < int(potion_limit / 4) and current_potions < potion_limit:
                new_teal_potions += 1
                num_blue_ml -= 50
                num_green_ml -= 50
                current_potions += 1
            if num_red_ml >= 33 and num_green_ml >= 34 and num_blue_ml >= 33 and white_potions < int(potion_limit / 4) and current_potions < potion_limit:
                new_white_potions += 1
                num_red_ml -= 33
                num_green_ml -= 34
                num_blue_ml -= 33
